...
function checkDifference(evt) {
	...
	if ((pos.x >= 230 && pos.y >= 140 && pos.x <= 290 && pos.y <= 180)||(pos.x >= 530 && pos.y >= 140 && pos.x <= 590 && pos.y <= 180) && differenceFound[0] == false && puzzleImage == "./Pictures/spongebob.jpg") {
	...
	if ((pos.x >= 230 && pos.y >= 70 && pos.x <= 260 && pos.y <= 100) ||(pos.x>=530 && pos.y >= 70 && pos.x <= 560 && pos.y <= 100) && differenceFound[1] == false && puzzleImage == "./Pictures/spongebob.jpg") {
		differenceFound[1] = true;
		foundADifference();
		drawCircle(245, 90, 545, 90, 20, 'green');
	}
	if ((pos.x >= 160 && pos.y >= 120 && pos.x <= 190 && pos.y <= 150)||(pos.x >= 460 && pos.y >= 120 && pos.x <= 490 && pos.y <= 150) && differenceFound[2] == false && puzzleImage == "./Pictures/spongebob.jpg") {
		differenceFound[2] = true;
		foundADifference();
		drawCircle(174, 135, 474, 135, 15, 'black');
	}
	if ((pos.x >= 260 && pos.y >= 15 && pos.x <= 290 && pos.y <= 45)||((pos.x >= 560 && pos.y >= 15 && pos.x <= 590 && pos.y <= 45)) && differenceFound[3] == false && puzzleImage == "./Pictures/spongebob.jpg") {
		differenceFound[3] = true;
		foundADifference();
		drawCircle(271, 24, 571, 24, 20, 'blue');
	}
	if ((pos.x >= 0 && pos.y >= 0 && pos.x <= 30 && pos.y <= 30)||(pos.x >= 300 && pos.y >= 0 && pos.x <= 330 && pos.y <= 30) && differenceFound[4] == false && puzzleImage == "./Pictures/spongebob.jpg") {
		differenceFound[4] = true;
		foundADifference();
		drawCircle(20, 14, 325, 14, 20, 'yellow');
	}
	if ((pos.x >= 0 && pos.y >= 215 && pos.x <= 30 && pos.y <= 245)||(pos.x >= 300 && pos.y >= 215 && pos.x <= 330 && pos.y <= 245) && differenceFound[0] == false && puzzleImage == "./Pictures/squidward.jpg") {
		differenceFound[0] = true;
		foundADifference();
		drawCircle(15, 231, 320, 231, 20, 'yellow');
	}
	if ((pos.x >= 0 && pos.y >= 0 && pos.x <= 10 && pos.y <= 30)||(pos.x >= 300 && pos.y >= 0 && pos.x <= 310 && pos.y <= 30) && differenceFound[1] == false && puzzleImage == "./Pictures/squidward.jpg") {
		differenceFound[1] = true;
		foundADifference();
		drawCircle(5, 10, 320, 15, 20, 'white');
	}
	if ((pos.x >= 180 && pos.y >= 30 && pos.x <= 210 && pos.y <= 60)||(pos.x >= 480 && pos.y >= 30 && pos.x <= 510 && pos.y <= 60) && differenceFound[2] == false && puzzleImage == "./Pictures/squidward.jpg") {
		differenceFound[2] = true;
		foundADifference();
		drawCircle(194, 43, 494, 43, 20, 'red');
	}
	if ((pos.x >= 100 && pos.y >= 245 && pos.x <= 130 && pos.y <= 275)||(pos.x >= 400 && pos.y >= 245 && pos.x <= 430 && pos.y <= 275) && differenceFound[3] == false && puzzleImage == "./Pictures/squidward.jpg") {
		differenceFound[3] = true;
		foundADifference();
		drawCircle(117, 257, 420, 257, 15, 'brown');
	}
	if ((pos.x >= 80 && pos.y >= 135 && pos.x <= 110 && pos.y <= 165)||(pos.x >= 30 && pos.y >= 135 && pos.x <= 410 && pos.y <= 165) && differenceFound[4] == false && puzzleImage == "./Pictures/squidward.jpg") {
		differenceFound[4] = true;
		foundADifference();
		drawCircle(95, 150, 395, 150, 20, 'black');
	}
	if ((pos.x >= 85 && pos.y >= 200 && pos.x <= 105 && pos.y <= 230)||(pos.x >= 385 && pos.y >= 200 && pos.x <= 405 && pos.y <= 230) && differenceFound[0] == false && puzzleImage == "./Pictures/panda.png") {
		differenceFound[0] = true;
		foundADifference();
		drawCircle(91, 207, 391, 207, 20, 'yellow');
	}
	if ((pos.x >= 115 && pos.y >= 200 && pos.x <= 145 && pos.y <= 230)||pos.x >= 415 && pos.y >= 200 && pos.x <= 445 && pos.y <= 230 && differenceFound[1] == false && puzzleImage == "./Pictures/panda.png") {
		differenceFound[1] = true;
		foundADifference();
		drawCircle(145, 215, 445, 215, 20, 'green');
	}
	if ((pos.x >= 200 && pos.y >= 35 && pos.x <= 230 && pos.y <= 65)||(pos.x >= 500 && pos.y >= 35 && pos.x <= 530 && pos.y <= 65) && differenceFound[2] == false && puzzleImage == "./Pictures/panda.png") {
		differenceFound[2] = true;
		foundADifference();
		drawCircle(218, 49, 518, 49, 20, 'red');
	}
	if ((pos.x >= 145 && pos.y >= 125 && pos.x <= 175 && pos.y <= 155)||(pos.x >= 445 && pos.y >= 125 && pos.x <= 475 && pos.y <= 155) && differenceFound[3] == false && puzzleImage == "./Pictures/panda.png") {
		differenceFound[3] = true;
		foundADifference();
		drawCircle(163, 140, 464, 140, 24, 'blue');
	}
	if ((pos.x >= 150 && pos.y >= 160 && pos.x <= 180 && pos.y <= 190)||(pos.x >= 450 && pos.y >= 160 && pos.x <= 480 && pos.y <= 190) && differenceFound[4] == false && puzzleImage == "./Pictures/panda.png") {
		differenceFound[4] = true;
		foundADifference();
